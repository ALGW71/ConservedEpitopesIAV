...
cd /home/alexgw/Dropbox/POSTDOC/Paper-CD4Flu/03_TCR_seq_data
...
public_alpha <- c('CAATRRGADGLTF', 'CAASSRIYNQGGKLIF', 'CAENNKGTSYGKLTF', 'CAENIRNARLMF',
                  'CALREANTGNQFYF', 'CALRTGNQFYF', 'CAFMRYNAGNMLTF', 'CAVEVLNSGNTPLVF',
                  'CAYLAGTASKLTF', 'CAYITGTASKLTF', 'CAYLTGTASKLTF', 'CAYRSTGNQFYF',
                  'CAVEGDNAGNKLTF', 'CAVEEGSSASKIIF', 'CAASFSDGQKLLF', 'CALSNDYKLSF',
                  'CAMSATDSWGKLQF', 'CAMSPTDSWGKLQF', 'CLVGDMNSGYSTLTF', 'CAVSEDTDKLIF')

public_beta <- c('CASSSPSGGAPYNEQFF', 'CSARDLQGAYNSPLHF', 'CSARDLQGSYNSPLHF', 
                 'CSARGLQGDYNSPLHF', 'CSAQDRDSGNTIYF', 'CASSLEGSPSQNTEAFF', 
                 'CASSPGGSSYEQYF', 'CSARRGGDTQYF', 'CASSVVGAGADTQYF')
...
cd /home/alexgw/Dropbox/POSTDOC/Paper-CD4Flu/03_TCR_seq_data/olga/

rm *NOMASK.out

# Start by doing this for just the CDR3, worry about VJ usage later...
parallel -j 6 'olga-compute_pgen -i {} --humanTRA -o {/.}_NOMASK.out' ::: /home/alexgw/Dropbox/POSTDOC/Paper-CD4Flu/03_TCR_seq_data/olga/fasta/Alpha_all.tsv

parallel -j 6 'olga-compute_pgen -i {} --humanTRB -o {/.}_NOMASK.out' ::: /home/alexgw/Dropbox/POSTDOC/Paper-CD4Flu/03_TCR_seq_data/olga/fasta/Beta_all.tsv
...
parallel -j 6 'olga-compute_pgen -i {} --humanTRA --v_in 1 --j_in 2 -o {/.}_VJ.out' ::: /home/alexgw/Dropbox/POSTDOC/Paper-CD4Flu/03_TCR_seq_data/olga/fasta/Alpha_all.tsv

parallel -j 6 'olga-compute_pgen -i {} --humanTRB --v_in 1 --j_in 2 -o {/.}_VJ.out' ::: /home/alexgw/Dropbox/POSTDOC/Paper-CD4Flu/03_TCR_seq_data/olga/fasta/Beta_all.tsv
