...
load ../coordinates/qar.pdb, qar
load ../coordinates/mtz_omit/qar_omit.mtz, map1

# ALIGN TO GMF FOR VIEWS
load ../coordinates/gmf.pdb, gmf
align qar, (/gmf//A, /gmf//B, /gmf//C)
# QAR IS MOBILE. GMF IS TEMPLATE
delete gmf
# ALIGN MATRICES
matrix_copy qar, map1.2fofc
matrix_copy qar, map1.fofc
...
# 1 sigma means in the electron omit variation above the average map
...
turn x,60
ray 4000,2000
png ../output/omit/qar_omit_top.png

hide everything, beta
turn x,-60
ray 4000,2000
png ../output/omit/qar_omit_side.png
