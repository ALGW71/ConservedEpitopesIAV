...
load ../coordinates/sgp.pdb, sgp
load ../coordinates/mtz_omit/sgp_omit.mtz, map1

# ALIGN TO GMF FOR VIEWS
load ../coordinates/gmf.pdb, gmf
align sgp, (/gmf//A, /gmf//B, /gmf//C)
# xxx is mobile. gmf is template.
delete gmf
# ALIGN MATRICES
matrix_copy sgp, map1.2fofc
matrix_copy sgp, map1.fofc
...
turn x,60
ray 4000,2000
png ../output/omit/sgp_omit_top.png

hide everything, beta
turn x,-60
ray 4000,2000
png ../output/omit/sgp_omit_side.png
